...
namespace GerenciadorDeEmprestimoDeJogos.Aplicacao.Test.Services
{
    public class ServicoDeEmprestimoTest
    {
        ...
        public void DeveRegistrarDevolucao()
        {
            ...
            var id = Guid.NewGuid();
            repositorio.Setup(x => x.RegistrarDevolucao(It.Is<string>(v => v.Equals("raphaelpanta@gmail.com")), It.Is<Guid>(v => v.Equals(id))));
            ...
            repositorio.Verify(x => x.RegistrarDevolucao(It.Is<string>(v => v.Equals("raphaelpanta@gmail.com")), It.Is<Guid>(v => v.Equals(id))), Times.Once());
